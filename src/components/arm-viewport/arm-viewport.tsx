...
import { Scene, PerspectiveCamera, WebGLRenderer, DirectionalLight, Object3D, Vector3, GridHelper, MOUSE, ColorRepresentation, Vector3Tuple } from "three";
...
export function ArmModel({ rotunda, elbow, shoulder, wristRoll, wristPitch, effectorPosition } : ArmState) {
    ...
    useEffect(() => {
        ...
        rotundaRef.current = findThreeSubobject(gltf.scene, "Base") ?? new Object3D();
